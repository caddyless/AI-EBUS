...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, ratio=1, in_channel=3, class_num=100):
        super().__init__()
        if ratio == 0.5:
...
def shufflenetv2(in_channel=3, num_class=2, **kwargs):
    return ShuffleNetV2(in_channel=in_channel, class_num=num_class)
