...
class PNASNet5Large(nn.Module):
    def __init__(self, in_channel, num_classes=1001):
        super(PNASNet5Large, self).__init__()
        self.num_classes = num_classes
        self.conv_0 = nn.Sequential(OrderedDict([
            ('conv', nn.Conv2d(in_channel, 96, kernel_size=3, stride=2, bias=False)),
...
def pnasnet5large(in_channel=3, num_class=2, pretrained=None):
