...
class Attention(nn.Module):
    ...
    def __init__(self, block_num, in_channel, class_num=100):
...
def attention56(in_channel=3, num_class=2):
    return Attention([1, 1, 1], in_channel=in_channel, class_num=num_class)


def attention92(in_channel=3, num_class=2):
    return Attention([1, 2, 3], in_channel=in_channel, class_num=num_class)
