...
class SqueezeExtracter(nn.Module):
...
class SqueezeNet(nn.Module):
    ...
    def __init__(self, in_channel=3, class_num=100):

        super().__init__()
        self.feature = SqueezeExtracter(in_channel)
...
def squeezenet(in_channel=3, num_class=2):
    return SqueezeNet(in_channel=in_channel, class_num=num_class)
