...
class EntryFlow(nn.Module):
    ...
    def __init__(self, in_channel=3):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channel, 32, 3, padding=1, bias=False),
            nn.BatchNorm2d(32),
...
class Xception(nn.Module):
    ...
    def __init__(self, block, in_channel=3, num_class=2):
        super().__init__()
        self.entry_flow = EntryFlow(in_channel=in_channel)
...
def xception(in_channel=3, num_class=2):
    return Xception(MiddleFLowBlock, in_channel=in_channel, num_class=num_class)
